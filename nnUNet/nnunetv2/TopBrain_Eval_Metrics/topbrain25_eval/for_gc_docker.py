...
def get_file_location(
    *, job_pk: str, values: list[dict], slug: str, input_dir: Path
    ...
    "relative_path": "images/head-mr-angio-segmentation"

    > Task 1: Head Angio Segmentation to
    **`/output/images/head-mr-angio-segmentation/<uuid>.mha`**
