...
class DefaultPreprocessor(object):
    ...
    def run_case_save(self, output_filename_truncated: str, image_files: List[str], seg_file: str,
        ...
        # blosc2 hard switch: compute access-pattern-aware block/chunk sizes from the configured patch
        # size and write {c}.b2nd / {c}_seg.b2nd (+ {c}.pkl) instead of {c}.npz.
        ...
        nnUNetDataset.save_case(data, seg, properties, output_filename_truncated,
