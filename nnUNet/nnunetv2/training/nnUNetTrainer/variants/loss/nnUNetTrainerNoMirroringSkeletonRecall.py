...
sys.path.insert(0, '/home/houjing/Project/TopCoW_Algo_Submission/task-1-seg')
# from cow_roi_binary_seg.utils.ct_io import save_nifti_file, load_nifti_file

class nnUNetTrainerNoMirroringSkeletonRecall(nnUNetTrainer):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
                 device: torch.device = torch.device('cuda')):
        super().__init__(plans, configuration, fold, dataset_json, unpack_dataset, device)
        self.weight_srec = 1 # This is the default value, you can change it if you want
        self.num_iterations_per_epoch = 250  # Debug 110
    ...
    def get_training_transforms(
        ...
        transforms.append(
            ...
            # Debug
            # Change different spatial parameters, which will be shown in saved processed samples.
            # SpatialTransform(
            #     patch_size_spatial, patch_center_dist_from_border=0, random_crop=False, p_elastic_deform=0,
            #     p_rotation=1,
    ...
    def train_step(self, batch: dict) -> dict:
        ...
        # Debug
        # Save these samples to disk so we know how the transformed images, skeleton and seg labels look like.
        ...
        #         continue
        #     exp_name = '150%Crop'
        #     out_d = f"/data/hohuan/Project/cow_roi_binary_seg/tmp/Aug29_visBatch_rotP1_scaleP1_{exp_name}/{str(batch['keys'][i])}"
        #     maybe_mkdir_p(out_d)
